...
model.load_weights('./cv_sttl_32_lstm_weights_3.h5', by_name=True, skip_mismatch=True)
...
def apprun(total_gen):
    ...
    with open('./Beam_bellman_vals_cv4/'+pickle_to_save_filename, "wb") as fp:   #Pickling
