...
def calculate_best_matches(total_matches, total_mismatches, total_matches_v2, total_mismatches_v2, matches_to_beat, mse_to_maintain, mse_matches_train):
    min_mse_index = random.randint(0, len(mse_matches_train) - 1)
    min_mse = mse_matches_train[min_mse_index]
...
def apprun(total_gen):
    ...
    pickle_to_save_filename = str(individual_id) + '_random_bellman_vals.txt'

    with open('./Random_bellman_vals_cv4/'+pickle_to_save_filename, "wb") as fp:   #Pickling
