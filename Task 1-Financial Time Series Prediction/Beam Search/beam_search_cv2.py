...
model.load_weights('./cv_sttl_32_lstm_weights_1.h5', by_name=True, skip_mismatch=True)
...
def apprun(total_gen):
    ...
    with open('./Beam_bellman_vals_cv2/'+pickle_to_save_filename, "wb") as fp:   #Pickling
