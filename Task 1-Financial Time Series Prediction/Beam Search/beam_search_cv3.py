...
model.load_weights('./cv_sttl_32_lstm_weights_2.h5', by_name=True, skip_mismatch=True)
...
def apprun(total_gen):
    ...
    for gen_index in range(total_gen):
        ...
        for item in change_track:
            ...
            if change_track.index(item) == 0:
                ...
                lstm_cell_kernel_alpha = np.array(new_alphas[0], dtype = 'float32')
                lstm_cell_recurrent_kernel_alpha = np.array(new_alphas[1], dtype = 'float32')
                lstm_cell_bias_alpha = np.array(new_alphas[2], dtype = 'float32')
                lstm_cell_1_kernel_alpha = np.array(new_alphas[3], dtype = 'float32')
                lstm_cell_1_recurrent_kernel_alpha = np.array(new_alphas[4], dtype = 'float32')
                lstm_cell_1_bias_alpha = np.array(new_alphas[5], dtype = 'float32')
                lstm_cell_2_kernel_alpha = np.array(new_alphas[6], dtype = 'float32')
                lstm_cell_2_recurrent_kernel_alpha = np.array(new_alphas[7], dtype = 'float32')
                lstm_cell_2_bias_alpha = np.array(new_alphas[8], dtype = 'float32')
                lstm_cell_3_kernel_alpha = np.array(new_alphas[9], dtype = 'float32')
                lstm_cell_3_recurrent_kernel_alpha = np.array(new_alphas[10], dtype = 'float32')
                lstm_cell_3_bias_alpha = np.array(new_alphas[11], dtype = 'float32')
                dense_kernel_alpha = np.array(new_alphas[12], dtype = 'float32')
                dense_bias_alpha = np.ones((1, ))
            ...
            new_alphas_modified = []
            new_alphas_modified.append(lstm_cell_kernel_alpha.tolist())
            new_alphas_modified.append(lstm_cell_recurrent_kernel_alpha.tolist())
            new_alphas_modified.append(lstm_cell_bias_alpha.tolist())
            new_alphas_modified.append(lstm_cell_1_kernel_alpha.tolist())
            new_alphas_modified.append(lstm_cell_1_recurrent_kernel_alpha.tolist())
            new_alphas_modified.append(lstm_cell_1_bias_alpha.tolist())
            new_alphas_modified.append(lstm_cell_2_kernel_alpha.tolist())
            new_alphas_modified.append(lstm_cell_2_recurrent_kernel_alpha.tolist())
            new_alphas_modified.append(lstm_cell_2_bias_alpha.tolist())
            new_alphas_modified.append(lstm_cell_3_kernel_alpha.tolist())
            new_alphas_modified.append(lstm_cell_3_recurrent_kernel_alpha.tolist())
            new_alphas_modified.append(lstm_cell_3_bias_alpha.tolist())
            new_alphas_modified.append(dense_kernel_alpha.tolist())
            new_alphas = new_alphas_modified
        ...
        if matches_to_beat > current_best_matches:
            ...
            new_weights_modified = []
            new_weights_modified.append(lstm_cell_kernel.tolist())
            new_weights_modified.append(lstm_cell_recurrent_kernel.tolist())
            new_weights_modified.append(lstm_cell_bias.tolist())
            new_weights_modified.append(lstm_cell_1_kernel.tolist())
            new_weights_modified.append(lstm_cell_1_recurrent_kernel.tolist())
            new_weights_modified.append(lstm_cell_1_bias.tolist())
            new_weights_modified.append(lstm_cell_2_kernel.tolist())
            new_weights_modified.append(lstm_cell_2_recurrent_kernel.tolist())
            new_weights_modified.append(lstm_cell_2_bias.tolist())
            new_weights_modified.append(lstm_cell_3_kernel.tolist())
            new_weights_modified.append(lstm_cell_3_recurrent_kernel.tolist())
            new_weights_modified.append(lstm_cell_3_bias.tolist())
            new_weights_modified.append(dense_kernel.tolist())
            new_weights = new_weights_modified
            #break
    ...
    pickle_to_save = []
    predicted_bellman_vals_to_save_id = all_mse_vals.index(min(all_mse_vals))
    ...
    pickle_to_save_filename = str(individual_id) + '_beam_bellman_vals.txt'
    print(all_matches[predicted_bellman_vals_to_save_id])
    print(all_mismatches[predicted_bellman_vals_to_save_id])

    with open('./Beam_bellman_vals_cv3/'+pickle_to_save_filename, "wb") as fp:   #Pickling
